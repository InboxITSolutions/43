         ...
         <!--  <div class="navbar-header">
          ...
          <div class="">
            <ul class="nav navbar-nav">
              ...
              <li class="page-icons" style="border-bottom:none !important;" ><a href="#" data-toggle="tooltip" data-placement="right" title="Contact us"><i class="fa fa-phone-square" aria-hidden="true"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
